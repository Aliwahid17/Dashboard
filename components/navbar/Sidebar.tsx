        ...
        <>
            ...
            <aside className=" md:flex flex-col px-3  shadow-md  w-auto border-r-2 border-r-gray-500 h-screen fixed text-gray-700 bg-slate-200  top-0 " title='StudentPortal '>
                ...
                <Link className="flex  mt-4 top-0" href="/">
                    ...
                    <h1 className=' flex text-lg ml-2 font-semibold mx-auto items-center justify-center'>StudentPortal</h1>
                </Link>

                <hr className=' flex-col w-auto mt-[14px] border-t-2 border-t-black' />
                ...
                <div className='thin-scroll scroll-smooth relative  '>
                    ...
                    <div className="flex flex-col  ">
                        ...
                        <Link className="flex items-center justify-center w-auto h-12 mt-1 rounded hover:bg-white   " href="/" title='Home' >
                            <div className='flex items-center justify-center w-12 h-12 ml-[2px]'>
                                <Image src={Home} alt="Home" width={33.35} height={33.35} />
                            </div>
                            <div className='flex text-base font-medium mx-auto items-center justify-center'>Home</div>
                        </Link>
                        <Link className="flex items-center justify-center w-auto h-12 mt-2 rounded hover:bg-white   " href="/" title='Tuition' >
                            <div className='flex items-center justify-center w-12 h-12 ml-[2px]'>
                        ...
                        <Link className="flex items-center justify-center w-auto h-12 mt-2 rounded hover:bg-white   " href="/" title='Store' >
                            ...
                            <div className='flex text-base font-medium mx-auto items-center justify-center'>Store</div>
                        </Link>
                        <Link className="flex items-center justify-center w-auto h-12 mt-2 rounded hover:bg-white   " href="/" title='Blogs' >
                            <div className='flex items-center justify-center w-12 h-12 ml-[2px]'>
                                <Image src={Blog} alt="Home" width={33.35} height={33.35} />
                            </div>
                            <div className='flex text-base font-medium mx-auto items-center justify-center'>Blogs</div>
                        </Link>
                        <Link className="flex items-center justify-center w-auto h-12 mt-2 rounded hover:bg-white   " href="/" title='Support' >
                            <div className='flex items-center justify-center w-12 h-12 ml-[2px]'>
                                <Image src={Support} alt="Home" width={33.35} height={33.35} />
                            </div>
                            <div className='flex text-base font-medium mx-auto items-center justify-center'>Support</div>
                        </Link>

                        <Link className="flex items-center justify-center w-auto h-12 mt-2 rounded hover:bg-white   " href="/settings" title=' Settings' >
                            <div className='flex items-center justify-center w-12 h-12 ml-[2px]'>
                                <Image src={Setting} alt="Home" width={33.35} height={33.35} />
                            </div>
                            <div className='flex text-base font-medium mx-auto items-center justify-center'>Settings</div>
                        </Link>
                ...
                <div className='flex absolute  bottom-0 px-3 flex-col left-0 w-[197.5px]  mt-auto bg-gray-300 border-r border-r-gray-500 '>

                    <hr className='w-auto mb-1 border-t-2 border-t-black' />

                    <button onClick={() => logOut()} className=" w-auto h-12 mb-1 flex items-center justify-center hover:bg-white  " title='LogOut'>
                        <div className='flex items-center justify-center w-12 h-12 ml-[2px]'>
                            <Image src={Logout} alt="LogOut" width={33.35} height={33.35} />
                        </div>
                        <div className='flex text-base font-medium mx-auto items-center justify-center'>LogOut</div>
                    </button>

                    <Link href={'#'} className=" w-auto h-12 flex items-center justify-center mb-2 hover:bg-white ">
                        <div className='flex items-center justify-center w-12 h-12 ml-[2px]'>
                            {user.photoURL && <Image className='rounded-full object-cover ' src={user.photoURL} alt="user" width={40} height={40} title={`${user.email}`} />}
                        </div>
                        <div className='flex text-base font-medium mx-auto items-center justify-center'>{user.displayName}</div>
                    </Link>
